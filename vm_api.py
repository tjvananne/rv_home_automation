...
async def process_data(record: SensorRecord, 
    ...
    vm_timestamp, hub_timestamp, raspi_timestamp, sensor_name, measurement, value, units)
    values (:vm_timestamp, :hub_timestamp, :raspi_timestamp, :sensor_name, :measurement, :value, :units)
    """, row_to_insert)
    con.commit()
